...
@section('content')
    ...
    <div class="product-container">
        <div class="product">
            ...
            <div class="wrapper">
                ...
                <div class="product__category">
                    ...
                    <a href="/products/{{ $product->species }}">{{ $product->species }}</a>
                </div>
        ...
        <div class="product__buttons">
            <button id="product-specifications" class="product-specifications product__button-clicked" tabindex="0">
                Specifications
            </button>
            ...
            <ul class="details">
                <li>
                    <svg class="plant-diameter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 140">
                        ...
                        <polygon
                            points="40.8,110 40.8,106.4 96.1,106.4 96.1,110 98.1,110 98.1,100.8 96.1,100.8 96.1,104.4 40.8,104.4 40.8,100.8 38.8,100.8 38.8,110">
                        </polygon>
                        <path
                            d="M98.6,110.5h-3v-3.7H41.3v3.7h-3v-10.3h3v3.7h54.3v-3.7h3V110.5z M96.6,109.5h1v-8.3h-1v3.7H40.3v-3.7h-1v8.3h1v-3.7h56.3 V109.5z">
                        </path>
                    </svg>
            ...
            <ul class="reviews-list">
                ...
                <li tabindex="0">
                    ...
                    <p class="review-text" tabindex="0">
                        Good quality and fast shipping. Just recieved my Hoya Parasitica Black Edge. I am so impressed. Huge
                        plant, much bigger than I expected from looking at the pictures. Arrived in perfect health and
                        condition. 5* rating, all the way.
                    </p>
                    <div class="rating">
                        <input type="radio" name="rating" value="5" id="5" />
                        <label for="5">☆</label>
    ...
    <div class="product__footer">
        <div class="product__footer-wrapper">
            <div class="product__footer-input-total">
                <div class="frame-container">
                    ...
                    <div class="number frame-container-column col-25">
                        <input class="product_quantity" id="quantity" type="number" value="1" min="1"
            ...
            <a href="{{ route('add.to.cart', ['id' => $product->id, 'quantity' => 1]) }}" type="button"
                class="product__footer-add-to-cart add-to-cart-anchor">Add to cart</a>
        </div>
