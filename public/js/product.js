...
var swiper = new Swiper('.swiper', {
  ...
  function update_total() {
    ...
    //   pass multiple arguments to ProductController
    const addToCartLink = document.querySelector('.add-to-cart-anchor');
    addToCartLink.href = addToCartLink.href.slice(0, -1) + `${quantity}`;
